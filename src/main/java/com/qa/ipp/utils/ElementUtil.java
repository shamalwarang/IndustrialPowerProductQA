...
public class ElementUtil {
	...
	// Method to select value in custom select
	public void selectValueFromCustomSelect(By dropDownLocator, By listLocator, By listFirstEleLocator, String value) {
		...
		doPresenceOfElementLocated(listFirstEleLocator, Constants.DEFAULT_TIME_OUT);
		waitForVisibilityOfElements(listFirstEleLocator, Constants.DEFAULT_TIME_OUT);
